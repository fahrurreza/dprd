          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table table-striped table-borderless">
                ...
                <tbody>
                    @foreach($data['partai'] as $list)
                    <tr>
                        <td>{{$loop->iteration}}</td>
                        <td>{{$list->partai}}</td>
                        <td>
                        <div class="badge badge-success" onclick="editPartai({{$list->id}}, '{{$list->partai}}')">Edit</div>
                        <div class="badge badge-danger" onclick="deletePartai({{$list->id}})">Delete</div>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
