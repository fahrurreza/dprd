                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="font-weight-medium">
                      <div class="btn badge badge-primary" onclick="showSubmenu({{$menu->id}})">Submenu</div>
                      <div class="btn badge badge-success" onclick="editFormMenu({{$menu->id}})">Edit</div>
                      <div class="btn badge badge-danger" onclick="deleteMenu({{$menu->id}})">Delete</div>
                  </td>
                  </tr>
                  @endforeach
                </tbody>
