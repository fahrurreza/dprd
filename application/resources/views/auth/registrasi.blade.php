        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-6 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" method="POST" action="{{ route('registrasi') }}">
                @csrf
                ...
                <div class="mt-3">
                  <a href="{{url('login')}}" class="btn btn-success btn-lg font-weight-medium auth-form-btn" type="submit" >KEMBALI</a>
