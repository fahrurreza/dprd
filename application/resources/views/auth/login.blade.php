          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo">
                <img src="{{asset('adm/images/logo-dprd.png')}}" alt="logo">
              </div>
              ...
              <form class="pt-3" method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg @error('username') is-invalid @enderror" name="username" placeholder="Username">
                </div>
                <div class="form-group">
                ...
                <div class="register">
                  Belum punya akun?? <a href="{{url('registrasi')}}">Daftar disini</a>
                  <p>
                    Press to back <a href="{{route('home')}}">Home</a>
                  </p>
                </div>
                <!-- <a class="btn btn-sm btn-success" href="{{route('home')}}">Home</a> -->
                <div class="mt-3">
