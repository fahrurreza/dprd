              ...
              <table class="table table-striped table-borderless">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><div class="btn badge badge-primary"><?php echo e($user->role); ?></div></td>
                    <td>
                        <a class="btn badge badge-danger" href="<?php echo e(url('admin-register-delete/'.$user->id)); ?>">Delete</a>
                    </td>
                  </tr>
...
<?php echo $__env->make('template/admin/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SERVER MEDIFIRST\htdocs\dprd\application\resources\views/admin/v_user.blade.php ENDPATH**/ ?>