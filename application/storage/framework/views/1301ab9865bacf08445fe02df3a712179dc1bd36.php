...
unset($__errorArgs, $__bag); ?>" name="password" placeholder="Password">
                ...
                <div class="register">
                  Belum punya akun?? <a href="<?php echo e(url('registrasi')); ?>">Daftar disini</a>
                  <p>
                    Press to back <a href="<?php echo e(route('home')); ?>">Home</a>
                  </p>
                </div>
                <!-- <a class="btn btn-sm btn-success" href="<?php echo e(route('home')); ?>">Home</a> -->
                <div class="mt-3">
...
</html><?php /**PATH D:\SERVER FUTREZ\htdocs\dprd\application\resources\views/auth/login.blade.php ENDPATH**/ ?>