...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item<?php echo e(request()->is('absen') ? ' active' : ''); ?>">
        <a class="nav-link" href="<?php echo e(url('/absen')); ?>">
            <i class="fas fa-fw fa-clock"></i>
            <span>Absensi Siswa</span></a>
    </li>
    <li class="nav-item<?php echo e(request()->is('nilai') ? ' active' : ''); ?>">
...
<!-- End of Sidebar --><?php /**PATH D:\XAMPP\htdocs\smk\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>