          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table table-striped table-borderless">
                ...
                <tbody>
                    <?php $__currentLoopData = $data['komisi']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($loop->iteration); ?></td>
                        <td><?php echo e($list->komisi); ?></td>
                        <td>
                        <div class="badge badge-success" onclick="editKomisi(<?php echo e($list->id); ?>, '<?php echo e($list->komisi); ?>')">Edit</div>
                        <div class="badge badge-danger" onclick="deleteKomisi(<?php echo e($list->id); ?>)">Delete</div>
                        </td>
                    </tr>
...
<?php echo $__env->make('template/admin/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SERVER\htdocs\dprd\application\resources\views/admin/v_komisi.blade.php ENDPATH**/ ?>