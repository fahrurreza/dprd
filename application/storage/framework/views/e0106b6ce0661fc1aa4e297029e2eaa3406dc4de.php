          ...
          <div class="row">
            <div class="col-6">
              <div class="form-group">
                <label for="menu">Nama Rapat</label>
                <input class="form-control" type="text" name="nama_rapat" id="nama_rapat">
              </div>
              <div class="form-group">
                <label for="menu">Acara Rapat</label>
                <input class="form-control" type="text" name="acara_rapat" id="acara_rapat">
              </div>
              <div class="form-group">
                <label for="menu">Tanggal Rapat</label>
                <input class="form-control" type="date" name="tgl_rapat" id="tgl_rapat">
              </div>
              <div class="form-group">
                <label for="menu">Waktu Rapat</label>
                <input class="form-control" type="time" name="waktu_rapat" id="waktu_rapat">
              </div>
              <div class="form-group">
                <label for="menu">Ruangan Rapat</label>
                <input class="form-control" type="text" name="ruang_rapat" id="ruang_rapat">
              </div>
              <div class="form-group">
                <label for="menu">Peserta Rapat</label>
              ...
              <table class="table table-striped table-borderless">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <center>
                              <div class="badge badge-primary" onclick="Selesai(<?php echo e($list->id); ?>)">Selesaikan</div>
...
<?php echo $__env->make('template/admin/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SERVER\htdocs\dprd\application\resources\views/admin/v_rapat.blade.php ENDPATH**/ ?>