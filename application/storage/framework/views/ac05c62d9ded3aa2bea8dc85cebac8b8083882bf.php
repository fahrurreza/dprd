...
<ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown no-arrow">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
            ...
            <a class="dropdown-item" href="<?php echo e(url('user/'.Auth::user()->id.'/edit')); ?>">
                Ganti Password
            </a>
        </div>
    </li>
...
<!-- End of Topbar --><?php /**PATH C:\xampp\htdocs\smk\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>