...
-->
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="#" class="logo">
                            <img src="<?php echo e(asset('user/images/logo.png')); ?>" alt="Softy Pinko"/>
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            ...
                            <li><a href="#contact-us">Pengaduan</a></li>
    ...
    <!-- ***** Welcome Area Start ***** -->
    <div class="welcome-area" id="welcome" style="background-image: url(<?php echo e(asset('user/images/dprdbinjai.jpg')); ?>);">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s">
                            <div class="features-small-item">
                                <div class="icon">
                                    <i><img src="<?php echo e(asset('user/images/featured-item-01.png')); ?>" alt=""></i>
                                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-12 col-sm-12 align-self-center" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                    <img src="<?php echo e(asset('user/images/left-image.png')); ?>" class="rounded img-fluid d-block mx-auto" alt="App">
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 align-self-center mobile-bottom-fix-big" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                    <img src="<?php echo e(asset('user/images/right-image.png')); ?>" class="rounded img-fluid d-block mx-auto" alt="App">
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-3 col-sm-6 col-6">
                        <a href="#" class="mini-box">
                            <i><img src="<?php echo e(asset('user/images/work-process-item-01.png')); ?>" alt=""></i>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="team-item">
                        <div class="team-content">
                            <i><img src="<?php echo e(asset('user/images/testimonial-icon.png')); ?>" alt=""></i>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="blog-post-thumb">
                        <div class="img">
                            <img src="<?php echo e(asset('user/images/blog-item-01.png')); ?>" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="blog-post-thumb">
                        <div class="img">
                            <img src="<?php echo e(asset('user/images/blog-item-02.png')); ?>" alt="">
                        </div>
                        <div class="blog-content">
                            <h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="blog-post-thumb">
                        <div class="img">
                            <img src="<?php echo e(asset('user/images/blog-item-03.png')); ?>" alt="">
                        </div>
                        <div class="blog-content">
                            <h3>
    ...
    <script>
        function redirec()
        {
            window.location.href = "http://localhost:8080/smk/admin";
        }
    </script>
  </body>
</html><?php /**PATH D:\SERVER\htdocs\smk\application\resources\views/dashboard/index.blade.php ENDPATH**/ ?>